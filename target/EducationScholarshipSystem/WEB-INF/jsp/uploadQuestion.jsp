...
<body>
<h3 align="center">Welcome ${sessionScope.institute.instituteName}</h3>
<h4><c:if test="${quploaded!=null}"> Question no ${quploaded} has been successfully uploaded</c:if></h4>
<table>
<form:form method="POST" name="myForm" id="myForm" action="/EducationScholarshipSystem/uploadQuestion" commandName="question">
	...
	<td><a href="/EducationScholarshipSystem/endUploadingQuestion">End uploading here</a></td>
	</tr>
	<input name="questionNo" value="${quetionno}" type="hidden"/>
</form:form>
</table>
</body>
</html>