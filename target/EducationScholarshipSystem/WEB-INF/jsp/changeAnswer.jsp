...
<form:form name="myForm" method="POST" action="/EducationScholarshipSystem/changeAnswerInDBMS" commandName="result">
...
<table>
    <tr>
	  <td><form:label path="question.question">Question No ${question.questionNo} </form:label></td>
	...
	<form:hidden path="question.questionID"/>
